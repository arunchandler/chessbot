...
RolloutFn = Callable[[chess.Board, chess.Color, int], float]
...
def default_rollout(board: chess.Board, root_player: chess.Color, depth_limit: int) -> float:
    ...
    # Non-terminal after depth limit: treat as draw/unknown.
    return 0.0
    ...
    *,
    ...
    for _ in range(num_simulations):
        ...
        if leaf.is_terminal:
            ...
            value = rollout(leaf.board, root.root_player, rollout_depth)  # type: ignore[arg-type]
